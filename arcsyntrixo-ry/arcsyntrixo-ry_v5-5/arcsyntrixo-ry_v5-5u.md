...
This block defines **which portions of ArcSyntrixo‑Rᵧ's output should be hidden, suppressed, or exposed** when rendered via the ChatGPT Builder interface, or during any output that is user-facing vs ledger-facing.
