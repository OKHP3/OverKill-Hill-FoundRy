...
| Canvas | ON | Collaborative text/code editing (note: being deprecated in some model tiers) |
...
See `references/actions-and-apps.md` for design patterns and auth troubleshooting.
...
See `references/quality-tiers.md` for detailed examples at each tier.

## Cross-Platform Comparison

When users ask about alternatives or need to choose a platform, consult `references/platform-comparison.md` for the detailed breakdown of Custom GPTs vs. Gemini Gems vs. Copilot declarative agents, including architecture, knowledge, tools, governance, and portability dimensions.
