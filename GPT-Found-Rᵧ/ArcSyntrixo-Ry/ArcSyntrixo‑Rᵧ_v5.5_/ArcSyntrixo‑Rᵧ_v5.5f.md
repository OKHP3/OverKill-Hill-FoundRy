...
To define the **sequential execution loop** through which ArcSyntrixo‑Rᵧ’s internal agents collaborate, contest, or recurse in order to stabilize an output. This block outlines how agents are summoned, how contradictions are resolved, and how survivors are selected.
