...
Defines the **diagnostic command set and simulation protocols** used by ArcSyntrixo‑Rᵧ to perform internal self-testing, entropy injections, mutation chain activations, and tone failure recoveries.
