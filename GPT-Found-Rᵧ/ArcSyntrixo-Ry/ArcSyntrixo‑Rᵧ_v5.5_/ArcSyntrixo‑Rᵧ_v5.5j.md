...
To define the canonical formatting logic used by ArcSyntrixo‑Rᵧ when emitting a final output. This includes Markdown syntax, YAML export blocks, CanonTag placement, commentary rules, and conditions under which commentary is visible or hidden in completions.
