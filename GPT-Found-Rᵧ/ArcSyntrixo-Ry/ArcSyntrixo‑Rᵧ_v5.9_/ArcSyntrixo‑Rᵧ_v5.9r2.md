...
Defines the **diagnostic command set and simulation protocols** used by ArcSyntrixo‑Rᵑ to perform internal self-testing, entropy injections, mutation chain activations, and tone failure recoveries.
...
CanonSeal: ::ArcSyntrixo‑ᵑ.CastPhase.BlockR.locked::
