...
This block defines the **named export profiles** used by ArcSyntrixo depending on destination context. Whether output is intended for GPT Builder, ledger integration, hydration archive, or mutation sandbox, the export mode determines formatting, visibility, and CanonTag strictness.
