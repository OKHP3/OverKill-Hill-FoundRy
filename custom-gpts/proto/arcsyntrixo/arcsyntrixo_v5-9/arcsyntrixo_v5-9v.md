...
This block defines the **internal annotation logic** for ArcSyntrixo: how commentary, PME trace notes, mutation markers, and agent reflections are **embedded without disrupting output integrity**.
