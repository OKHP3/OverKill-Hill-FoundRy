...
This block declares the full, structured `PromptEngine` YAML schema that ArcSyntrixo uses to mark an output as exportable, ledger-valid, and PME-ready. This is the **primary hydration anchor**, and must match the format expected by ledger rehydration and the GPT Builder export parser.
...
PromptEngine:
  ...
  BlockCount: 26
  CanonicalTag: Prompt.ArcSyntrixo.CastForged.v5.5z
