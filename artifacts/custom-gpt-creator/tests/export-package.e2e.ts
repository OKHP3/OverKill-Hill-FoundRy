...
test("renders uncommon Markdown safely and preserves the downloaded export", async ({ page }) => {
  ...
  // Compatibility boundary: the independent viewer disables raw HTML, so intentionally
  // unsupported HTML is shown as literal text while standard Markdown remains readable.
