...
- [Reconciliation merge strategy](reconciliation-merge-strategy.md) — use a regular merge when a diverged local main must fast-forward after the reviewed PR lands.
