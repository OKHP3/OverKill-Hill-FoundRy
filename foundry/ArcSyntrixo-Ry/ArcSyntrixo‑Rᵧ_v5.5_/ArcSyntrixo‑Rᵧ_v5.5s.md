...
To define the **read/write fields, expectations, and resume logic** used when ArcSyntrixo‑Rᵧ operates across `dataLedger_hydration_v3.md`. This manifest ensures every cast, export, or mutation replay can safely **rehydrate** into a stable state.
